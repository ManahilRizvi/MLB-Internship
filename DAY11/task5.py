...
#histogram equalization improves overall image contrast and 
...
#and histogram equalization may over enhance some image regions
#clahe provides usually more natural looking image 