...
allMatches, goodMatch=featuresMatching(descriptor1, descriptor2)
print("Good Match before Ransac: ", len(goodMatch))
print("Feature Matching....")
print("Total Matches: ", len(allMatches))
...
for index in inlierIndices:
    ransacMatches.append(goodMatch[index])
print("RANSAC...")
print("Inliers after Ransac: ", len(ransacMatches))
beforeRansac=matchImg(img1, img2, kp1, kp2, goodMatch, [255, 0, 0])
afterRansac=matchImg(img1, img2, kp1, kp2, ransacMatches, [0, 255, 0])
